...
class COPYApplicantsModule {
    ...
    // Basic Data
    inputBasicData(){
            cy.xpath(this.applicants).should('be.visible').click()
            cy.xpath(this.addApplicant).should('be.visible').click()
            cy.xpath(this.firstNameField).type(this.firstName)
            cy.xpath(this.lastNameField).type(this.lastName)
            cy.xpath(this.emailField).type(this.email)
            cy.xpath(this.homePhoneField).type(this.homePhone)
            cy.xpath(this.mobilePhoneField).type(this.mobilePhone)
    ...
    // Personal Info
    inputPersonalInfo(){  
        cy.xpath(this.personalInfoAccordian).should('be.visible').click()
        cy.xpath(this.addressField).type(this.address)
        cy.xpath(this.cityField).type(this.city)
        cy.xpath(this.stateField).type(this.state)
        cy.xpath(this.zipCodeField).type(this.zipCode)    
        ...
        cy.xpath(this.tbTestingField).type(this.tbTestingDate)
        cy.xpath(this.addLanguageIcon).should('be.visible').click()
...
export default new COPYApplicantsModule();
